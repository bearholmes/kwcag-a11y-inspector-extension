...
import { CONSTANTS, HEX_CHARS } from './constants.js';

/**
 * 10진수를 16진수로 변환하는 함수
 * @param {number} nb - 10진수 값
 * @returns {string} 16진수 문자열 (2자리)
 */
 ...
 */
export function RGBToHexStr(str) {
  try {
 ...
 * @param {number} L1 - 첫 번째 색상의 Luminance 값
 * @param {number} L2 - 두 번째 색상의 Luminance 값
 * @returns {number} 명도 대비율
 */
